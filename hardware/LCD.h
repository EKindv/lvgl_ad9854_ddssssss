...
#define SPI_CS  PAout(15)			//片选端口										
#define SPI_SDI PBout(5)			//数据输入											
#define SPI_SDI_RD PBin(5)		//SDA单通道时候 作为数据输出		
#define SPI_SDO PBin(4)			//数据输出									  
#define SPI_RST PDout(7)			//复位  	    		 							
#define SPI_SCK PBout(3)			//时钟													
#define SPI_DC PDout(6)			//数据/命令      								  
#define	LCD_LED PDout(15) 			//背光 开关
